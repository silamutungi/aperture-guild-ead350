...
const SEED_LISTINGS: Listing[] = [
  { id: '1', title: 'Golden Hour Over the Dolomites', description: 'A breathtaking panorama captured at first light.', price: 149, license_type: 'commercial', category: 'Landscape', tags: ['mountain', 'sunrise', 'italy'], image_url: '', photographer_name: 'Elena Vasquez', photographer_id: 'p1', photographer_avatar: '', camera_model: 'Sony A7R V', aperture: 'f/8', shutter_speed: '1/60s', iso: 100, focal_length: '24mm', location: 'Dolomites, Italy', created_at: '2024-03-15', deleted_at: null },
  { id: '2', title: 'Tokyo Neon Rain', description: 'Street photography at its most electric, Shinjuku 2am.', price: 89, license_type: 'editorial', category: 'Street', tags: ['tokyo', 'rain', 'night'], image_url: '', photographer_name: 'Haruto Mori', photographer_id: 'p2', photographer_avatar: '', camera_model: 'Fujifilm X-T5', aperture: 'f/2', shutter_speed: '1/30s', iso: 3200, focal_length: '35mm', location: 'Shinjuku, Tokyo', created_at: '2024-02-28', deleted_at: null },
  { id: '3', title: 'Serengeti Predawn Migration', description: 'Wildebeest crossing at dusk, a once-in-a-decade shot.', price: 299, license_type: 'commercial', category: 'Wildlife', tags: ['africa', 'wildlife', 'migration'], image_url: '', photographer_name: 'Amara Diallo', photographer_id: 'p3', photographer_avatar: '', camera_model: 'Nikon Z9', aperture: 'f/4', shutter_speed: '1/500s', iso: 800, focal_length: '400mm', location: 'Serengeti, Tanzania', created_at: '2024-01-10', deleted_at: null },
  { id: '4', title: 'Icelandic Aurora Reflection', description: 'Northern lights mirrored in a still volcanic lake.', price: 199, license_type: 'commercial', category: 'Landscape', tags: ['aurora', 'iceland', 'night'], image_url: '', photographer_name: 'Sigrid Bjornsdottir', photographer_id: 'p4', photographer_avatar: '', camera_model: 'Canon EOS R5', aperture: 'f/2.8', shutter_speed: '15s', iso: 1600, focal_length: '16mm', location: 'Myvatn, Iceland', created_at: '2024-03-02', deleted_at: null },
  { id: '5', title: 'Monsoon Chai Vendor', description: 'Intimate portrait of a tea seller in the Mumbai rain.', price: 75, license_type: 'editorial', category: 'Portrait', tags: ['india', 'portrait', 'rain'], image_url: '', photographer_name: 'Priya Sharma', photographer_id: 'p5', photographer_avatar: '', camera_model: 'Leica M11', aperture: 'f/1.4', shutter_speed: '1/125s', iso: 400, focal_length: '50mm', location: 'Mumbai, India', created_at: '2024-02-14', deleted_at: null },
  { id: '6', title: 'Patagonia Glacier Calving', description: 'The moment of impact — 200 tons of ice meets ocean.', price: 349, license_type: 'commercial', category: 'Nature', tags: ['patagonia', 'glacier', 'climate'], image_url: '', photographer_name: 'Carlos Ruiz', photographer_id: 'p6', photographer_avatar: '', camera_model: 'Phase One IQ4', aperture: 'f/5.6', shutter_speed: '1/1000s', iso: 200, focal_length: '100mm', location: 'Los Glaciares, Argentina', created_at: '2024-03-20', deleted_at: null },
]
...
export default function Home() {
  return (
    <div style={{ background: 'var(--color-bg)' }}>
      ...
      {/* Hero: solid ink background, no external image */}
      <section
        style={{ backgroundColor: 'var(--color-ink, #1C1a18)' }}
        className="relative min-h-[100svh] flex items-center overflow-hidden"
      >
        <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #1C1a18 0%, #2B2420 50%, #1C1a18 100%)' }} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SEED_LISTINGS.map((listing, i) => (
              <Link key={listing.id} to={`/listing/${listing.id}`} className="group block rounded-xl overflow-hidden" style={{ border: '1px solid var(--color-border)', background: 'var(--color-bg)' }}>
                <div className="aspect-[4/3] overflow-hidden flex items-center justify-center" style={{ background: LISTING_COLORS[i % LISTING_COLORS.length] }}>
                  <div className="text-center px-4">
                    <div className="text-4xl mb-2">📷</div>
                    <p className="text-white/70 text-xs font-medium">{listing.category}</p>
                  </div>
                </div>
                <div className="p-4">
